...
import { getNotifications, getUnreadCount, markNotificationRead } from '@/api/client';
    ...
    <div style={{ position: 'relative' }} ref={dropdownRef}>
      ...
      {isOpen && (
        ...
        >
          ...
          >
            <h3 style={{ margin: 0, fontSize: '16px', fontWeight: '600', color: '#1e293b' }} className="dark:text-white">
              Notifications
            </h3>
            <button
              ...
              {notifications.map((notification) => (
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <span style={{ fontSize: '11px', color: '#64748b' }} className="dark:text-slate-400">
