                ...
                <main className="main">
                  <section className="hero">
                    ...
                    <p className="subtitle">
                      Craft, annotate, and evaluate conversational AI datasets
                      and templates—all in one place.
                    </p>
                  ...
                  <section className="grid">
                    {entries.map((e) => (
                      <div key={e.key} className="card">
                        <h2>{e.name}</h2>
                        <p>
                          Open the module embedded in the portal or launch it in
                          a separate tab.
                        </p>
                        <div className="row">
              ...
              <div className="shell">
                ...
                <main className="main">
                  <section className="hero">
                    ...
                    <p className="subtitle">
                      The page you’re looking for doesn’t exist. You can enter
                      the portal or open a module below.
                    </p>
